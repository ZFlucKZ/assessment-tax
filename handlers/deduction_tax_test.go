...
//! Comment test cases that use database, external API, network,...
// import "testing"
...
// 			totalIncome, _ := calculatePersonalDeductionTax(tt.income, tt.personal)
...
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
// 			totalIncome, _ := calculateDonationDeductionTax(tt.income, tt.donation)
// 			if totalIncome != tt.want {
